# Manual Screenshot Coverage (Completed)

All previously missing screenshots have now been captured and saved in `docs/manual-assets/images/`.
...
- Numbered callout variants also exist for key flows:
